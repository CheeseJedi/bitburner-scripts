/** @param {NS} ns */
// Only slightly modified from version at: https://www.reddit.com/r/Bitburner/comments/rmpgn5/map_code/
var _ns;
...
function ChildCountCompare(a, b) {
	var ax = ChildCount(a); // Unused, could be removed?
	var bx = ChildCount(b); // Unused, could be removed?
